...
# guardamos los datos sin dupliv¿cados en un csv
...
#### Revisión en detalle de incossietncias 
...
Basado en la menor diferencia relativa de medias y desviaciones, así como la preservación de correlaciones, se selecciona **PMM** con ridge como método final. Este método presenta la mayor estabilidad (baja desviación entre imputaciones) y reproduce fielmente la estructura correlacional.
