...
- **Customer_Days:** Alta antigüedad promedio (≈3000 días = 8 años), indicando lealtad.
...
Tras la eliminación de registros duplicados, la base quedó compuesta por *2.041* resgistros.
...
Dado que el p-valor = `r round(test_little$p.value, 4)` < 0.05, se rechaza $H_{0}$. En consecuencia, los datos no siguen un mecanismo completamente aleatorio (**MCAR**). No obstante, dado el bajo porcentaje de ausencia (**<5%**) y la ausencia de evidencia estructural de **MNAR**, se asume razonablemente un mecanismo **MAR** para efectos de imputación múltiple.
...
Se comparan tres métodos: **PMM** con regularización ridge, **CART** y **Regresión ridge**
